...
tested on WordPress 7.1, 7.0.4, 6.9.1, 6.8.3, 6.6.
...
3. Then "Select file" <a href="https://github.com/payneteasy/php-plugin-woocommerce/releases/download/v1.6.0/wc-payneteasy.zip">wc-payneteasy.zip</a>
...
7. And then after filling necessary parameters, click "Save"<br><img src="installation/7.png" alt="plugin installation step 7, editing and saving configuration" width="450"/>
